...
* Return         : None
*******************************************************************************/
// This function is commented out so you can implement it as 
//    an assembly-language subroutine in assembly.s
/*
...
* Input          : The service that was requested
*                      // we should allow multiple arguments
* Output         : None
* Return         : None
*******************************************************************************/
void SWI_Handler(int service) // ...
{
}
/*******************************************************************************
